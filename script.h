...
extern void strcata(char *str1, char *str2, int align = 45);
extern void TrimLeft(char *sz);
extern bool Script_inc_si();
extern int  ScriptWriteSz(char *sz);
extern int  ScriptWriteToken(char *token);
extern bool ScriptSkipToReturn();
extern bool ScriptSkipToCmd();
extern bool ScriptSkipToParam();
extern void ScriptWordLock();
extern void ScriptWordUnlock();
extern void ScriptWordRead(char *sz);
extern void ScriptLineLock();
extern void ScriptLineUnlock();
extern void ScriptLineRead(char *sz);



extern bool ScriptCompile(SCRIPTINFO *scriptinfo, char *szf, HANDLE hlog);
extern bool ScriptDecompile(SCRIPTINFO *scriptinfo, HANDLE hfile);
